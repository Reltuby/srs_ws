...
'''
UR5 control node that evaluates all fruit then attempts to pick them all. Does not reevaluate to adjust for fruit movement
...
class FruitPickerNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("All Fruit Picker Initialised")
    ...
    def publish_joint_states(self):
        ...
        try:
            ...
            #convert the joint positions to a ros message and publish
            if joint_positions:
    ...
    def process_fruit_positions(self, msg):
        '''move to home position and pick fruit'''
        try:
            ...
            #iterate through each fruit in list
            for fruit in fruit_positions:   
                ...
                if len(position) == 3 and rotation:
                    self.home = False
                    #stop publishing images form camera
    ...
    def pick_fruit(self, position, rotation):
        ...
        try:
            ...
            #set desired pose with normal and reverse oriented gripper
    ...
    def rotate_local_rx(self, base_pose, local_ry_angle):
        ...
        #change this number to change picking angle
        ...
        #does matrix math to rotate the head correctly
    ...
    def stop_robot(self):
        ...
        #stop anything currently happening on the robot
        self.rtde_c.stopScript()
        #disconnect from the data exchange interfaces
