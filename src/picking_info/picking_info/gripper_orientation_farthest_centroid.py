...
'''
This node sorts the detected kiwifruit by creating a cluster centroid and picking the fruit furthest away from this centroid
...
class GripperOrientationNode(Node):
    ...
    def centroid_data_callback(self, msg):
        ...
        try:
            ...
            #only get class 1 (kiwifruit) ignore calyxes
    ...
    def calculate_picking_order(self, centroids, radius=0.11):
        '''sort kiwifruit by finding the farthest fruit from a cluster centroid'''
